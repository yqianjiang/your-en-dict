import{s as A,x as ie,y as Te,z as Re,r as N,A as ke,B as Ee,D as m,E as v,G as He,H as be,I as Ie,J as y,K as u,L as de,M as je,N as L,O as Oe,i as Ge,k as D,P as pe,Q as De,R as t,S as K,T as Ne,U as Fe,V as Me,W as We,X as _e}from"./main.js";import{a as he,c as ce,r as ue,i as Ke,b as Ve}from"./userDict.js";import{u as Ae,f as Le,g as Qe,d as fe}from"./use-form-item.js";function qe(e,a="default",f=[]){const c=e.$slots[a];return c===void 0?f:c()}const F=typeof document<"u"&&typeof window<"u",Ue=A("base-wave",`
 position: absolute;
 left: 0;
 right: 0;
 top: 0;
...
`),Je=ie({name:"BaseWave",props:{clsPrefix:{type:String,required:!0}},setup(e){Te("-base-wave",Ue,Re(e,"clsPrefix"));const a=N(null),f=N(!1);let i=null;return ke(()=>{i!==null&&window.clearTimeout(i)}),{active:f,selfRef:a,play(){i!==null&&(window.clearTimeout(i),f.value=!1,i=null),Ee(()=>{var c;(c=a.value)===null||c===void 0||c.offsetHeight,f.value=!0,i=window.setTimeout(()=>{f.value=!1,i=null},1e3)})}}},render(){const{clsPrefix:e}=this;return m("div",{ref:"selfRef","aria-hidden":!0,class:[`${e}-base-wave`,this.active&&`${e}-base-wave--active`]})}}),{cubicBezierEaseInOut:B}=He;function Ye({duration:e=".2s",delay:a=".1s"}={}){return[v("&.fade-in-width-expand-transition-leave-from, &.fade-in-width-expand-transition-enter-to",{opacity:1}),v("&.fade-in-width-expand-transition-leave-to, &.fade-in-width-expand-transition-enter-from",`
 ...
 margin-left ${e} ${B},
 margin-right ${e} ${B};
 `)]}function I(e){return be(e,[255,255,255,.16])}function V(e){return be(e,[0,0,0,.12])}const Xe=Ie("n-button-group"),Ze=F&&"chrome"in window;F&&navigator.userAgent.includes("Firefox");const eo=F&&navigator.userAgent.includes("Safari")&&!Ze,oo=v([A("button",`
 margin: 0;
 ...
 align-items: center;
 justify-content: center;
 `,[je({top:"50%",originalTransform:"translateY(-50%)"})]),Ye()]),u("content",`
 display: flex;
 align-items: center;
 flex-wrap: nowrap;
 min-width: 0;
 ...
 display: flex;
 width: 100%;
 `),y("dashed",[u("border, state-border",{borderStyle:"dashed !important"})]),y("disabled",{cursor:"not-allowed",opacity:"var(--n-opacity-disabled)"})]),v("@keyframes button-wave-spread",{from:{boxShadow:"0 0 0.5px 0 var(--n-ripple-color)"},to:{boxShadow:"0 0 0.5px 4.5px var(--n-ripple-color)"}}),v("@keyframes button-wave-opacity",{from:{opacity:"var(--n-wave-opacity)"},to:{opacity:0}})]),ro=Object.assign(Object.assign({},L.props),{color:String,textColor:String,text:Boolean,block:Boolean,loading:Boolean,disabled:Boolean,circle:Boolean,size:String,ghost:Boolean,round:Boolean,secondary:Boolean,tertiary:Boolean,quaternary:Boolean,strong:Boolean,focusable:{type:Boolean,default:!0},keyboard:{type:Boolean,default:!0},tag:{type:String,default:"button"},type:{type:String,default:"default"},dashed:Boolean,iconPlacement:{type:String,default:"left"},attrType:{type:String,default:"button"},bordered:{type:Boolean,default:!0},onClick:[Function,Array],nativeFocusBehavior:{type:Boolean,default:!eo}}),to=ie({name:"Button",props:ro,setup(e){const a=N(null),f=N(null),i=N(!1),c=Oe(()=>!e.quaternary&&!e.tertiary&&!e.secondary&&!e.text&&(!e.color||e.ghost||e.dashed)&&e.bordered),h=Ge(Xe,{}),{mergedSizeRef:P}=Ae({},{defaultSize:"medium",mergedSize:r=>{const{size:b}=e;if(b)return b;const{size:x}=h;if(x)return x;const{mergedSize:o}=r||{};return o?o.value:"medium"}}),C=D(()=>e.focusable&&!e.disabled),j=r=>{var b;C.value||r.preventDefault(),!e.nativeFocusBehavior&&(r.preventDefault(),!e.disabled&&C.value&&((b=a.value)===null||b===void 0||b.focus({preventScroll:!0})))},T=r=>{var b;if(!e.disabled&&!e.loading){const{onClick:x}=e;x&&Ve(x,r),e.text||(b=f.value)===null||b===void 0||b.play()}},Q=r=>{switch(r.key){case"Enter":if(!e.keyboard)return;i.value=!1}},q=r=>{switch(r.key){case"Enter":if(!e.keyboard||e.loading){r.preventDefault();return}i.value=!0}},O=()=>{i.value=!1},{inlineThemeDisabled:G,mergedClsPrefixRef:w,mergedRtlRef:U}=pe(e),S=L("Button","-button",oo,De,e,w),R=he("Button",U,w),k=D(()=>{const r=S.value,{common:{cubicBezierEaseInOut:b,cubicBezierEaseOut:x},self:o}=r,{rippleDuration:J,opacityDisabled:M,fontWeight:Y,fontWeightStrong:X}=o,g=P.value,{dashed:Z,type:E,ghost:ee,text:$,color:s,round:ae,circle:oe,textColor:H,secondary:ve,tertiary:se,quaternary:me,strong:ge}=e,ye={"font-weight":ge?X:Y};let l={"--n-color":"initial","--n-color-hover":"initial","--n-color-pressed":"initial","--n-color-focus":"initial","--n-color-disabled":"initial","--n-ripple-color":"initial","--n-text-color":"initial","--n-text-color-hover":"initial","--n-text-color-pressed":"initial","--n-text-color-focus":"initial","--n-text-color-disabled":"initial"};const W=E==="tertiary",le=E==="default",n=W?"default":E;if($){const d=H||s,p=d||o[t("textColorText",n)];l={"--n-color":"#0000","--n-color-hover":"#0000","--n-color-pressed":"#0000","--n-color-focus":"#0000","--n-color-disabled":"#0000","--n-ripple-color":"#0000","--n-text-color":p,"--n-text-color-hover":d?I(d):o[t("textColorTextHover",n)],"--n-text-color-pressed":d?V(d):o[t("textColorTextPressed",n)],"--n-text-color-focus":d?I(d):o[t("textColorTextHover",n)],"--n-text-color-disabled":d||o[t("textColorTextDisabled",n)]}}else if(ee||Z){const d=H||s;l={"--n-color":"#0000","--n-color-hover":"#0000","--n-color-pressed":"#0000","--n-color-focus":"#0000","--n-color-disabled":"#0000","--n-ripple-color":s||o[t("rippleColor",n)],"--n-text-color":d||o[t("textColorGhost",n)],"--n-text-color-hover":d?I(d):o[t("textColorGhostHover",n)],"--n-text-color-pressed":d?V(d):o[t("textColorGhostPressed",n)],"--n-text-color-focus":d?I(d):o[t("textColorGhostHover",n)],"--n-text-color-disabled":d||o[t("textColorGhostDisabled",n)]}}else if(ve){const d=le?o.textColor:W?o.textColorTertiary:o[t("color",n)],p=s||d,_=E!=="default"&&E!=="tertiary";l={"--n-color":_?K(p,{alpha:Number(o.colorOpacitySecondary)}):o.colorSecondary,"--n-color-hover":_?K(p,{alpha:Number(o.colorOpacitySecondaryHover)}):o.colorSecondaryHover,"--n-color-pressed":_?K(p,{alpha:Number(o.colorOpacitySecondaryPressed)}):o.colorSecondaryPressed,"--n-color-focus":_?K(p,{alpha:Number(o.colorOpacitySecondaryHover)}):o.colorSecondaryHover,"--n-color-disabled":o.colorSecondary,"--n-ripple-color":"#0000","--n-text-color":p,"--n-text-color-hover":p,"--n-text-color-pressed":p,"--n-text-color-focus":p,"--n-text-color-disabled":p}}else if(se||me){const d=le?o.textColor:W?o.textColorTertiary:o[t("color",n)],p=s||d;se?(l["--n-color"]=o.colorTertiary,l["--n-color-hover"]=o.colorTertiaryHover,l["--n-color-pressed"]=o.colorTertiaryPressed,l["--n-color-focus"]=o.colorSecondaryHover,l["--n-color-disabled"]=o.colorTertiary):(l["--n-color"]=o.colorQuaternary,l["--n-color-hover"]=o.colorQuaternaryHover,l["--n-color-pressed"]=o.colorQuaternaryPressed,l["--n-color-focus"]=o.colorQuaternaryHover,l["--n-color-disabled"]=o.colorQuaternary),l["--n-ripple-color"]="#0000",l["--n-text-color"]=p,l["--n-text-color-hover"]=p,l["--n-text-color-pressed"]=p,l["--n-text-color-focus"]=p,l["--n-text-color-disabled"]=p}else l={"--n-color":s||o[t("color",n)],"--n-color-hover":s?I(s):o[t("colorHover",n)],"--n-color-pressed":s?V(s):o[t("colorPressed",n)],"--n-color-focus":s?I(s):o[t("colorFocus",n)],"--n-color-disabled":s||o[t("colorDisabled",n)],"--n-ripple-color":s||o[t("rippleColor",n)],"--n-text-color":H||(s?o.textColorPrimary:W?o.textColorTertiary:o[t("textColor",n)]),"--n-text-color-hover":H||(s?o.textColorHoverPrimary:o[t("textColorHover",n)]),"--n-text-color-pressed":H||(s?o.textColorPressedPrimary:o[t("textColorPressed",n)]),"--n-text-color-focus":H||(s?o.textColorFocusPrimary:o[t("textColorFocus",n)]),"--n-text-color-disabled":H||(s?o.textColorDisabledPrimary:o[t("textColorDisabled",n)])};let re={"--n-border":"initial","--n-border-hover":"initial","--n-border-pressed":"initial","--n-border-focus":"initial","--n-border-disabled":"initial"};$?re={"--n-border":"none","--n-border-hover":"none","--n-border-pressed":"none","--n-border-focus":"none","--n-border-disabled":"none"}:re={"--n-border":o[t("border",n)],"--n-border-hover":o[t("borderHover",n)],"--n-border-pressed":o[t("borderPressed",n)],"--n-border-focus":o[t("borderFocus",n)],"--n-border-disabled":o[t("borderDisabled",n)]};const{[t("height",g)]:te,[t("fontSize",g)]:xe,[t("padding",g)]:Ce,[t("paddingRound",g)]:we,[t("iconSize",g)]:Se,[t("borderRadius",g)]:ze,[t("iconMargin",g)]:$e,waveOpacity:Be}=o,Pe={"--n-width":oe&&!$?te:"initial","--n-height":$?"initial":te,"--n-font-size":xe,"--n-padding":oe||$?"initial":ae?we:Ce,"--n-icon-size":Se,"--n-icon-margin":$e,"--n-border-radius":$?"initial":oe||ae?te:ze};return Object.assign(Object.assign(Object.assign(Object.assign({"--n-bezier":b,"--n-bezier-ease-out":x,"--n-ripple-duration":J,"--n-opacity-disabled":M,"--n-wave-opacity":Be},ye),l),re),Pe)}),z=G?Ne("button",D(()=>{let r="";const{dashed:b,type:x,ghost:o,text:J,color:M,round:Y,circle:X,textColor:g,secondary:Z,tertiary:E,quaternary:ee,strong:$}=e;b&&(r+="a"),o&&(r+="b"),J&&(r+="c"),Y&&(r+="d"),X&&(r+="e"),Z&&(r+="f"),E&&(r+="g"),ee&&(r+="h"),$&&(r+="i"),M&&(r+="j"+ce(M)),g&&(r+="k"+ce(g));const{value:s}=P;return r+="l"+s[0],r+="m"+x[0],r}),k,e):void 0;return{selfElRef:a,waveElRef:f,mergedClsPrefix:w,mergedFocusable:C,mergedSize:P,showBorder:c,enterPressed:i,rtlEnabled:R,handleMousedown:j,handleKeydown:q,handleBlur:O,handleKeyup:Q,handleClick:T,customColorCssVars:D(()=>{const{color:r}=e;if(!r)return null;const b=I(r);return{"--n-border-color":r,"--n-border-color-hover":b,"--n-border-color-pressed":V(r),"--n-border-color-focus":b,"--n-border-color-disabled":r}}),cssVars:G?void 0:k,themeClass:z==null?void 0:z.themeClass,onRender:z==null?void 0:z.onRender}},render(){const{mergedClsPrefix:e,tag:a,onRender:f}=this;f==null||f();const i=ue(this.$slots.default,c=>c&&m("span",{class:`${e}-button__content`},c));return m(a,{ref:"selfElRef",class:[this.themeClass,`${e}-button`,`${e}-button--${this.type}-type`,`${e}-button--${this.mergedSize}-type`,this.rtlEnabled&&`${e}-button--rtl`,this.disabled&&`${e}-button--disabled`,this.block&&`${e}-button--block`,this.enterPressed&&`${e}-button--pressed`,!this.text&&this.dashed&&`${e}-button--dashed`,this.color&&`${e}-button--color`,this.secondary&&`${e}-button--secondary`,this.loading&&`${e}-button--loading`,this.ghost&&`${e}-button--ghost`],tabindex:this.mergedFocusable?0:-1,type:this.attrType,style:this.cssVars,disabled:this.disabled,onClick:this.handleClick,onBlur:this.handleBlur,onMousedown:this.handleMousedown,onKeyup:this.handleKeyup,onKeydown:this.handleKeydown},this.iconPlacement==="right"&&i,m(Fe,{width:!0},{default:()=>ue(this.$slots.icon,c=>(this.loading||c)&&m("span",{class:`${e}-button__icon`,style:{margin:Ke(this.$slots.default)?"0":""}},m(Me,null,{default:()=>this.loading?m(We,{clsPrefix:e,key:"loading",class:`${e}-icon-slot`,strokeWidth:20}):m("div",{key:"icon",class:`${e}-icon-slot`,role:"none"},c)})))}),this.iconPlacement==="left"&&i,this.text?null:m(Je,{ref:"waveElRef",clsPrefix:e}),this.showBorder?m("div",{"aria-hidden":!0,class:`${e}-button__border`,style:this.customColorCssVars}):null,this.showBorder?m("div",{"aria-hidden":!0,class:`${e}-button__state-border`,style:this.customColorCssVars}):null)}}),bo=to,no=()=>_e,io={name:"Space",self:no},ao=io;let ne;const so=()=>{if(!F)return!0;if(ne===void 0){const e=document.createElement("div");e.style.display="flex",e.style.flexDirection="column",e.style.rowGap="1px",e.appendChild(document.createElement("div")),e.appendChild(document.createElement("div")),document.body.appendChild(e);const a=e.scrollHeight===1;return document.body.removeChild(e),ne=a}return ne},lo=Object.assign(Object.assign({},L.props),{align:String,justify:{type:String,default:"start"},inline:Boolean,vertical:Boolean,size:{type:[String,Number,Array],default:"medium"},wrapItem:{type:Boolean,default:!0},itemStyle:[String,Object],wrap:{type:Boolean,default:!0},internalUseGap:{type:Boolean,default:void 0}}),po=ie({name:"Space",props:lo,setup(e){const{mergedClsPrefixRef:a,mergedRtlRef:f}=pe(e),i=L("Space","-space",void 0,ao,e,a),c=he("Space",f,a);return{useGap:so(),rtlEnabled:c,mergedClsPrefix:a,margin:D(()=>{const{size:h}=e;if(Array.isArray(h))return{horizontal:h[0],vertical:h[1]};if(typeof h=="number")return{horizontal:h,vertical:h};const{self:{[t("gap",h)]:P}}=i.value,{row:C,col:j}=Qe(P);return{horizontal:fe(j),vertical:fe(C)}})}},render(){const{vertical:e,align:a,inline:f,justify:i,itemStyle:c,margin:h,wrap:P,mergedClsPrefix:C,rtlEnabled:j,useGap:T,wrapItem:Q,internalUseGap:q}=this,O=Le(qe(this));if(!O.length)return null;const G=`${h.horizontal}px`,w=`${h.horizontal/2}px`,U=`${h.vertical}px`,S=`${h.vertical/2}px`,R=O.length-1,k=i.startsWith("space-");return m("div",{role:"none",class:[`${C}-space`,j&&`${C}-space--rtl`],style:{display:f?"inline-flex":"flex",flexDirection:e?"column":"row",justifyContent:["start","end"].includes(i)?"flex-"+i:i,flexWrap:!P||e?"nowrap":"wrap",marginTop:T||e?"":`-${S}`,marginBottom:T||e?"":`-${S}`,alignItems:a,gap:T?`${h.vertical}px ${h.horizontal}px`:""}},!Q&&(T||q)?O:O.map((z,r)=>m("div",{role:"none",style:[c,{maxWidth:"100%"},T?"":e?{marginBottom:r!==R?U:""}:j?{marginLeft:k?i==="space-between"&&r===R?"":w:r!==R?G:"",marginRight:k?i==="space-between"&&r===0?"":w:"",paddingTop:S,paddingBottom:S}:{marginRight:k?i==="space-between"&&r===R?"":w:r!==R?G:"",marginLeft:k?i==="space-between"&&r===0?"":w:"",paddingTop:S,paddingBottom:S}]},z)))}});export{bo as N,po as a,F as i};

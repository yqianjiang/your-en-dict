import{n as X,A as be,ab as Ge,D as Ae,r as q,Q as Me,a7 as qe,J as y,x as g,ac as Ve,ad as Be,Y as Le,y as S,q as p,z as me,s as Ke,C as Z,a0 as Qe,i as Ue,G as F,B as Te,ae as Ye,W as _e,L as r,l as U,H as Je,K as ge,af as Xe,I as Ze,N as eo,M as oo,O as to,ag as ro,ah as no,o as j,c as G,S as ye,F as ce,a as xe,w as Y,d as de,e as A,u as M,h as fe,R as we,b as Ce,f as ao,v as io}from"./main.js";import{_ as so}from"./-plugin-vue-export-helper.js";import{c as ze,N as Se}from"./userDict.js";import{u as lo,c as co,d as $e}from"./Suffix.js";function uo(e,l="default",a=[]){const c=e.$slots[l];return c===void 0?a:c()}const V=typeof document<"u"&&typeof window<"u",fo=X("base-wave",`
 position: absolute;
 left: 0;
 right: 0;
 top: 0;
...
`),bo=be({name:"BaseWave",props:{clsPrefix:{type:String,required:!0}},setup(e){Ge("-base-wave",fo,Ae(e,"clsPrefix"));const l=q(null),a=q(!1);let n=null;return Me(()=>{n!==null&&window.clearTimeout(n)}),{active:a,selfRef:l,play(){n!==null&&(window.clearTimeout(n),a.value=!1,n=null),qe(()=>{var c;(c=l.value)===null||c===void 0||c.offsetHeight,a.value=!0,n=window.setTimeout(()=>{a.value=!1,n=null},1e3)})}}},render(){const{clsPrefix:e}=this;return y("div",{ref:"selfRef","aria-hidden":!0,class:[`${e}-base-wave`,this.active&&`${e}-base-wave--active`]})}}),{cubicBezierEaseInOut:R}=Ve;function po({duration:e=".2s",delay:l=".1s"}={}){return[g("&.fade-in-width-expand-transition-leave-from, &.fade-in-width-expand-transition-enter-to",{opacity:1}),g("&.fade-in-width-expand-transition-leave-to, &.fade-in-width-expand-transition-enter-from",`
 opacity: 0!important;
 ...
 margin-left ${e} ${R},
 margin-right ${e} ${R};
 `)]}function I(e){return Be(e,[255,255,255,.16])}function J(e){return Be(e,[0,0,0,.12])}const ho=Le("n-button-group"),vo=V&&"chrome"in window;V&&navigator.userAgent.includes("Firefox");const mo=V&&navigator.userAgent.includes("Safari")&&!vo,go=g([X("button",`
 margin: 0;
 ...
 `,[S("active",{zIndex:1,animationName:"button-wave-spread, button-wave-opacity"})]),V&&"MozBoxSizing"in document.createElement("div").style?g("&::moz-focus-inner",{border:0}):null,p("border, state-border",`
 position: absolute;
 left: 0;
 top: 0;
 right: 0;

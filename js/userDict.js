...
`,[f("strong",`
 ...
 `,[y("disabled",[_("&:hover","background-color: var(--n-color-checked-hover);"),_("&:active","background-color: var(--n-color-checked-pressed);")])])])]),So=Object.assign(Object.assign(Object.assign({},D.props),Po),{bordered:{type:Boolean,default:void 0},checked:Boolean,checkable:Boolean,strong:Boolean,onClose:[Array,Function],onMouseenter:Function,onMouseleave:Function,"onUpdate:checked":Function,onUpdateChecked:Function,internalCloseFocusable:{type:Boolean,default:!0},internalStopClickPropagation:Boolean,onCheckedChange:{type:Function,validator:()=>!0,default:void 0}}),wo=Wo("n-tag"),Mo=go({name:"Tag",props:So,setup(r){const o=uo(null),{mergedBorderedRef:e,mergedClsPrefixRef:g,inlineThemeDisabled:c,mergedRtlRef:d}=Co(r),t=D("Tag","-tag",Io,_o,r,g);bo(wo,{roundRef:vo(r,"round")});function a(s){if(!r.disabled&&r.checkable){const{checked:l,onCheckedChange:k,onUpdateChecked:C,"onUpdate:checked":b}=r;C&&C(!l),b&&b(!l),k&&k(!l)}}function i(s){if(r.internalStopClickPropagation&&s.stopPropagation(),!r.disabled){const{onClose:l}=r;l&&mo(l,s)}}const p={setTextContent(s){const{value:l}=o;l&&(l.textContent=s)}},W=ko("Tag",d,g),u=N(()=>{const{type:s,size:l,color:{color:k,textColor:C}={}}=r,{common:{cubicBezierEaseInOut:b},self:{padding:S,closeMargin:w,closeMarginRtl:z,borderRadius:$,opacityDisabled:H,textColorCheckable:B,textColorHoverCheckable:M,textColorPressedCheckable:R,textColorChecked:T,colorCheckable:O,colorHoverCheckable:j,colorPressedCheckable:E,colorChecked:J,colorCheckedHover:q,colorCheckedPressed:A,closeBorderRadius:G,fontWeightStrong:X,[h("colorBordered",s)]:Y,[h("closeSize",l)]:Q,[h("closeIconSize",l)]:Z,[h("fontSize",l)]:oo,[h("height",l)]:U,[h("color",s)]:eo,[h("textColor",s)]:ro,[h("border",s)]:no,[h("closeIconColor",s)]:K,[h("closeIconColorHover",s)]:so,[h("closeIconColorPressed",s)]:lo,[h("closeColorHover",s)]:co,[h("closeColorPressed",s)]:ao}}=t.value;return{"--n-font-weight-strong":X,"--n-avatar-size-override":`calc(${U} - 8px)`,"--n-bezier":b,"--n-border-radius":$,"--n-border":no,"--n-close-icon-size":Z,"--n-close-color-pressed":ao,"--n-close-color-hover":co,"--n-close-border-radius":G,"--n-close-icon-color":K,"--n-close-icon-color-hover":so,"--n-close-icon-color-pressed":lo,"--n-close-icon-color-disabled":K,"--n-close-margin":w,"--n-close-margin-rtl":z,"--n-close-size":Q,"--n-color":k||(e.value?Y:eo),"--n-color-checkable":O,"--n-color-checked":J,"--n-color-checked-hover":q,"--n-color-checked-pressed":A,"--n-color-hover-checkable":j,"--n-color-pressed-checkable":E,"--n-font-size":oo,"--n-height":U,"--n-opacity-disabled":H,"--n-padding":S,"--n-text-color":C||ro,"--n-text-color-checkable":B,"--n-text-color-checked":T,"--n-text-color-hover-checkable":M,"--n-text-color-pressed-checkable":R}}),v=c?fo("tag",N(()=>{let s="";const{type:l,size:k,color:{color:C,textColor:b}={}}=r;return s+=l[0],s+=k[0],C&&(s+=`a${L(C)}`),b&&(s+=`b${L(b)}`),e.value&&(s+="c"),s}),u,r):void 0;return Object.assign(Object.assign({},p),{rtlEnabled:W,mergedClsPrefix:g,contentRef:o,mergedBordered:e,handleClick:a,handleCloseClick:i,cssVars:c?void 0:u,themeClass:v==null?void 0:v.themeClass,onRender:v==null?void 0:v.onRender})},render(){var r,o;const{mergedClsPrefix:e,rtlEnabled:g,closable:c,color:{borderColor:d}={},round:t,onRender:a,$slots:i}=this;a==null||a();const p=F(i.avatar,u=>u&&x("div",{class:`${e}-tag__avatar`},u)),W=F(i.icon,u=>u&&x("div",{class:`${e}-tag__icon`},u));return x("div",{class:[`${e}-tag`,this.themeClass,{[`${e}-tag--rtl`]:g,[`${e}-tag--strong`]:this.strong,[`${e}-tag--disabled`]:this.disabled,[`${e}-tag--checkable`]:this.checkable,[`${e}-tag--checked`]:this.checkable&&this.checked,[`${e}-tag--round`]:t,[`${e}-tag--avatar`]:p,[`${e}-tag--icon`]:W,[`${e}-tag--closable`]:c}],style:this.cssVars,onClick:this.handleClick,onMouseenter:this.onMouseenter,onMouseleave:this.onMouseleave},W||p,x("span",{class:`${e}-tag__content`,ref:"contentRef"},(o=(r=this.$slots).default)===null||o===void 0?void 0:o.call(r)),!this.checkable&&c?x(po,{clsPrefix:e,class:`${e}-tag__close`,disabled:this.disabled,onClick:this.handleCloseClick,focusable:this.internalCloseFocusable,round:t,absolute:!0}):null,!this.checkable&&this.mergedBordered?x("div",{class:`${e}-tag__border`,style:{borderColor:d}}):null)}}),V="yourdict";function zo(r){return JSON.stringify(r)}function $o(r,o=""){if(!r)return o;let e="";try{e=JSON.parse(r)}catch{e=r}return e||o}function P(r,o){o!=null&&localStorage.setItem(`${V}:${r}`,zo(o))}function I(r){return $o(localStorage.getItem(`${V}:${r}`))}class Ho{constructor(){this._knownWords={},this._unknownWords={},this._seenWords={},this.targetWords=[],this.load()}get knownWords(){return Object.keys(this._knownWords)}get unknownWords(){return Object.keys(this._unknownWords)}get seenWords(){return Object.keys(this._seenWords)}get knownTargetWords(){return this.targetWords.filter(o=>o in this._knownWords)}get unknownTargetWords(){return this.targetWords.filter(o=>o in this._knownWords)}load(){this._knownWords=I("knownWords")||{},this._unknownWords=I("unknownWords")||{},this._seenWords=I("seenWords")||{},this.targetWords=I("targetWords")||[]}save(){P("knownWords",this._knownWords),P("unknownWords",this._unknownWords),P("seenWords",this._seenWords),P("targetWords",this.targetWords)}_genWordMeta(o){return{createdTime:new Date().toUTCString()}}_addKnownWord(o){this.knownWords.includes(o)||(this.unknownWords.includes(o)&&this.removeUnknownWord(o),this._knownWords[o]=this._genWordMeta(o))}_addUnknownWord(o){this.unknownWords.includes(o)||(this.knownWords.includes(o)&&(console.log("remove knownWord",o),this.removeKnownWord(o),console.log(this._knownWords[o])),this._unknownWords[o]=this._genWordMeta(o))}_addSeenWord(o,e){this.seenWords.includes(o)&&(this._seenWords[o].freq+=e),this._seenWords[o]={...this._genWordMeta(o),freq:e}}addKnownWords(o){for(const e of o)this._addKnownWord(e)}addUnknownWords(o){for(const e of o)this._addUnknownWord(e)}addSeenWords(o){for(const[e,g]of o)this._addSeenWord(e,g)}removeKnownWord(o){delete this._knownWords[o]}removeUnknownWord(o){delete this._unknownWords[o]}}const Ro=new Ho;export{Mo as N,L as c,I as g,P as s,Ro as u};
